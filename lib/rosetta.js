...
exports.compile = function(sources, options, callback) {
  ...
  var replaceIndex = options.cssOut.indexOf('{{ns}}');
  if (replaceIndex >= 0 && replaceIndex >= options.cssOut.length - 6) {
    callback('options.cssOut: You must specify a file extension after {{ns}}.');
    return;
  }
